...
dos alunos da Inglaterra. No entanto, os alunos acharam estranho, pois na Inglaterra o sistema de notas é diferente: 
...
notas de conceitos:
nota 0 = E, nota ate 35 = D, nota ate 60 = C, nota ate 85 = B, nota ate 100 = A
