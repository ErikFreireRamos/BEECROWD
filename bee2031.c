/*
Pedra, Papel, Ataque Aéreo é um jogo infantil muito popular, em que duas ou mais crianças formam um círculo e fazem gestos com a 
mão na tentativa de obter a vitória. As regras são surpreendentemente complexas para um jogo de crianças, mas mesmo assim é 
bastante popular por todo o mundo.
...
Uma partida, com dois jogadores, possuem as seguintes regras para se definir um vencedor:
    ...
    Pedra vs. Pedra: Para este caso não há ganhador, porque depende do que os jogadores decidem fazer com a Pedra e normalmente 
    não fazem nada.
...
A primeira string representa o sinal escolhido pelo jogador 1 e a segunda string representa o sinal escolhido pelo jogador 2. 
...
int main(void){
    ...
    if((strcmp(jogador1,"ataque")==0) && (strcmp(jogador2,"pedra")==0)){printf("Jogador 1 venceu\n");}
    else if((strcmp(jogador1,"pedra")==0) && (strcmp(jogador2,"papel")==0)){printf("Jogador 1 venceu\n");}
    else if((strcmp(jogador1,"ataque")==0) && (strcmp(jogador2,"papel")==0)){printf("Jogador 1 venceu\n");}
    else if((strcmp(jogador1,"papel")==0) && (strcmp(jogador2,"papel")==0)){printf("Ambos venceram\n");}
    else if((strcmp(jogador1,"pedra")==0) && (strcmp(jogador2,"pedra")==0)){printf("Sem ganhador\n");}
    else if((strcmp(jogador1,"ataque")==0) && (strcmp(jogador2,"ataque")==0)){printf("Aniquilacao mutua\n");}
